...
class EditArtistWidget extends StatefulWidget {
  ...
  @override
  _EditArtistWidgetState createState() => _EditArtistWidgetState();
}
...
class _EditArtistWidgetState extends State<EditArtistWidget> {
  ...
  void initState() {
    ...
    stageNameController.text = widget.artist?.stageName ?? "";

    listenersController = TextEditingController();
    listenersController.text = widget.artist?.listeners?.toString() ?? "";

    realNameController = TextEditingController();
    realNameController.text = widget.artist?.name ?? "";

    birthdayController = TextEditingController();
    birthdayController.text = widget.artist?.birthday ?? "";

    ageController = TextEditingController();
    ageController.text = widget.artist?.age?.toString() ?? "";

    companyController = TextEditingController();
    companyController.text = widget.artist?.company ?? "";

    backgroundController = TextEditingController();
    backgroundController.text = widget.artist?.background ?? "";

    positions = widget.artist!.position!;
    groups = widget.artist!.groups!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Row(
        children: [
          const Expanded(child: Text('Edit Artist')),
          TextButton(
              onPressed: _validation()
                  ? () {
                      setState(() {
                        ...
                        widget.updateArtist(widget.id, artist);
